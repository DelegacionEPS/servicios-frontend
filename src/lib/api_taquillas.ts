...
export async function reservaTaquilla(
    taquilla: FormDataEntryValue | null | String,
    usuario: FormDataEntryValue | null | Number,
    correo: FormDataEntryValue | null | String,
    nombre: FormDataEntryValue | null | String
) {
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK reservando taquilla",
                response.status,
                response.statusText
            )
        }
...
export async function reservaOsciloscopio(
    puesto: FormDataEntryValue | null | Number,
    nia: FormDataEntryValue | null | String,
    hora: FormDataEntryValue | null | Number,
    dia: FormDataEntryValue | null | Date,
    correo: FormDataEntryValue | null | String,
    nombre: FormDataEntryValue | null | String,
    semana: FormDataEntryValue | null | Number
) {
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK reservando osciloscopio",
                response.status,
                response.statusText
            )
        }
...
export async function reservaTaquillaAsociacion(
    taquilla: FormDataEntryValue | null | String,
    correo: FormDataEntryValue | null | String,
    nombre: FormDataEntryValue | null | String
) {
...
export async function ocupacionBloque(edificio: String, planta: String) {
    try {
        const response = await fetch(
            `${BASE_URL_API}/api/ocupacionBloque/${edificio}/${planta}${TOKEN}`
        )
        if (!response.ok) {
            throw new Error("Network response was not ok")
        }
...
export async function addUserRol(
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK añadiendo rol",
                response.status,
                response.statusText
            )
        }
...
export async function add_user_db(email: String, name: String | null | undefined) {
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK add_user_db",
                response.status,
                response.statusText
            )
        }
...
export async function add_association_db(email: String, name: String | null | undefined) {
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK add_association_db",
                response.status,
                response.statusText
            )
        }
...
export async function getReservasNia(nia: FormDataEntryValue | null | String) {
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK when consulting NIA",
                response.status,
                response.statusText
            )
        }
...
export async function getReservasTaquilla(taquilla: FormDataEntryValue | null | String) {
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK, when consulting taquilla",
                response.status,
                response.statusText
            )
        }
...
export async function aceptaReserva(
    taquilla: FormDataEntryValue | null | String,
    responsable: FormDataEntryValue | null | String
) {
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK aceptando reserva",
                response.status,
                response.statusText
            )
        }
...
export async function eliminaReserva(
    taquilla: FormDataEntryValue | null | String,
    responsable: FormDataEntryValue | null | String
) {
    const taquilla_res = taquilla || ""
...
export async function eliminaReservaOsciloscopio(
    puesto: FormDataEntryValue | null | Number,
    hora: FormDataEntryValue | null | Number,
    fecha: FormDataEntryValue | null | String,
    responsable: FormDataEntryValue | null | String
) {
    let responsable_res = responsable || ""
    if (responsable_res === "") {
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK eliminando reserva",
                response.status,
                response.statusText
            )
        }
...
export async function completaReservaOsciloscopio(
    puesto: FormDataEntryValue | null | Number,
    hora: FormDataEntryValue | null | Number,
    fecha: FormDataEntryValue | null | String,
    responsable: FormDataEntryValue | null | String
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK completando reserva",
                response.status,
                response.statusText
            )
        }
...
export async function descompletaReservaOsciloscopio(
    puesto: FormDataEntryValue | null | Number,
    hora: FormDataEntryValue | null | Number,
    fecha: FormDataEntryValue | null | String,
    responsable: FormDataEntryValue | null | String
    ...
    try {
        const response = await fetch(
            `${BASE_URL_API}/api/descompletaReservaOsciloscopios${TOKEN}`,
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK descompletando reserva",
                response.status,
                response.statusText
            )
        }
...
export async function backupDB(email: FormDataEntryValue | null | String) {
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK when backing up DB",
                response.status,
                response.statusText
            )
        }
...
export async function deleteDB(email: FormDataEntryValue | null | String) {
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK when deleting DB",
                response.status,
                response.statusText
            )
        }
...
export async function getReservasDia(dia: FormDataEntryValue | null | String) {
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK when getting bookings per day",
                response.status,
                response.statusText
            )
        }
...
export async function marcarRota(
    taquilla: FormDataEntryValue | null | String,
    correo: FormDataEntryValue | null | String
) {
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK when marking rota",
                response.status,
                response.statusText
            )
        }
...
export async function arreglarTaquilla(
    taquilla: FormDataEntryValue | null | String,
    correo: FormDataEntryValue | null | String
) {
    try {
...
export async function banUser(
    user: FormDataEntryValue | null | Number,
    dias: FormDataEntryValue | null | Number,
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK when banning user",
                response.status,
                response.statusText
            )
        }
...
export async function unbanUser(
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK when unbanning user",
                response.status,
                response.statusText
            )
        }
...
export async function changeOsciloscopioState(
    email: FormDataEntryValue | null | String,
    puesto: FormDataEntryValue | null | Number,
    estado: FormDataEntryValue | null | Number
) {
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK when changing the osciloscopio state",
                response.status,
                response.statusText
            )
        }
...
export async function changeHoraState(
    email: FormDataEntryValue | null | String,
    dia: FormDataEntryValue | null | String,
    hora: FormDataEntryValue | null | Number,
    estado: FormDataEntryValue | null | String
) {
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK when changing the hour state",
                response.status,
                response.statusText
            )
        }
...
export async function changePlantilla(
    email: FormDataEntryValue | null | String,
    dia: FormDataEntryValue | null | Number,
    hora: FormDataEntryValue | null | Number,
    estado: FormDataEntryValue | null | Number
) {
    try {
        ...
        if (response.ok) {
            ...
            console.error(
                "Server response was not OK when changing the template",
                response.status,
                response.statusText
            )
        }
