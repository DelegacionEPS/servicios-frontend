<script lang="ts">
    ...
    const pageTitle = "Servicios de Delegación | Escuela Politécnica Superior UC3M"
    const pageDescription =
        "Gestión de taquillas, puestos de electrónica y más servicios para estudiantes de la UC3M. Reserva online y consulta disponibilidad."

    // Structured data for Organization
    const organizationSchema = {
        "@context": "https://schema.org",
        "@type": "EducationalOrganization",
        name: "Delegación de Estudiantes EPS UC3M",
        description:
            "Delegación de estudiantes de la Escuela Politécnica Superior de la Universidad Carlos III de Madrid",
        email: "delegeps@uc3m.es",
        url: "https://servicios.delegacioneps.es",
        location: {
            "@type": "Place",
            name: "Despacho 1.0.H01",
            address: {
                "@type": "PostalAddress",
...
<!-- Hero Section - Enhanced with gradient, animation and better semantic structure -->
<main>
    <section
        ...
        <div class="container mx-auto px-4 py-20 md:py-12">
            <div class="text-center mb-14 animate-fadeIn">
                ...
                <p
                    ...
                    Gestión de taquillas, puestos de electrónica y más servicios para estudiantes de
                    la UC3M
                </p>
            </div>
                ...
                <div class="lg:w-1/2 w-full">
                    <div
                        ...
                        <p
                            ...
                            La delegación de estudiantes gestiona las taquillas de la universidad.
                            Si quieres alquilar una, simplemente tendrás que elegir la que quieres y
                            luego rellenar un
                            <span
                                class="underline hover:dark:text-dark-accent hover:recompensa:text-recompensa-accent hover:text-accent font-medium">
                            ...
                            <br />
                            <br />
                            Para poder reservar, primero debes escoger el edificio y la planta. Tras
                            ello, deberás seleccionar un bloque para escoger la taquilla que quieras
                            reservar.
                        </p>
                    </div>
                </div>
                ...
                <div class="lg:w-1/2 w-full">
                    <div
                        ...
                        <p
                            ...
                            servicio a la máxima cantidad posible de estudiantes, sólo se podrá
                            reservar una franja de 2 horas por semana.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-16">
                <div class="lg:w-1/2 w-full">
                    <div
                        ...
                        <p
                            class="text-gray-700 dark:text-gray-200 recompensa:text-gray-200 text-lg leading-relaxed">
                            Si quieres saber el porcentaje de participación por grado en las
                            encuestas de evaluación del profesorado, haz click en el siguiente
                            botón. Actualmente, se muestran las encuestas del primer cuatrimeste del
                            curso 2024/2025.
                            <br />
                            <br />
                            Es muy importante participar en las encuestas, ya que con los resultados,
                            podemos centrar los esfuerzos en las asignaturas que más lo necesitan.
                        </p>
                    </div>
                </div>
                <div class="lg:w-1/3 w-full">
            ...
            <div class="grid md:grid-cols-3 grid-cols-1 gap-10 max-w-5xl mx-auto">
                ...
                <div
                    ...
                    <p class="text-gray-700 dark:text-white recompensa:text-white text-lg">
                        ...
                        portabilidad y oposición a su tratamiento, mediante el envío de un correo a
                        la siguiente dirección: dpd@uc3m.es
                    </p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-700 dark:text-white recompensa:text-white text-lg">
                        Puede consultar la información adicional y detallada sobre nuestra Política
                        de Privacidad
                        <a
